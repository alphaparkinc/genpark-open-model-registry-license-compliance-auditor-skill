# genpark-open-model-registry-license-compliance-auditor-skill
...
> **GenPark AI Agent Skill** -- Open model registry & license compliance auditor (OpenCSG Starship style)
